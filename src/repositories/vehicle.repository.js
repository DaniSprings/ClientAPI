...
const VEHICLE_SELECT = [
  ...
  "extrastable ( airconditioning:airConditioning, rearair-conditioningcontrols:rearAirConditioningControls, powersteering:powerSteering, electricpowersteering:electricPowerSteering, leathersteeringwheeltrim:leatherSteeringWheelRim, multi-functionsteeringwheelcontrols:multiFunctionSteeringWheelControls, lanedeparturewarning:laneDepartureWarning, fatiguedetection:attentionAssist, head-updisplay:headUpDisplay, controlsscreeninputmethod:controlsScreenInputMethod, navigation:navigation, cruisecontrol:cruiseControl, adaptivecruisecontrol:adaptiveCruiseControl, Bluetoothconnectivity:bluetooth, usbport:usbPort, electricwindows:electricWindows, reardemister:heatedRearScreen, autodimexteriormirrors:autoDimExteriorMirrors, suedeclothupholstery:suedeClothUpholstery, leatherupholstery:leatherUpholstery, lumbarsupport:lumbarSupportAdjustment, electricseatadjustmentdriver:electricDriverSeat, electricseatadjustment:electricSeatMemory, ventilatedseatsfront:frontVentilatedSeats )",
